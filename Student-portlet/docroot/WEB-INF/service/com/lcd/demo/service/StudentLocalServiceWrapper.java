...
public class StudentLocalServiceWrapper implements StudentLocalService,
	...
	*/
	...
	public com.lcd.demo.model.Student addStudents(java.lang.String name,
		...
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		return _studentLocalService.addStudents(name, age, gender, phone,
			address, fileImage, linkImage, serviceContext);
	}
	...
	public com.lcd.demo.model.Student updateStudent(long studentId,
		...
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		return _studentLocalService.updateStudent(studentId, nameNew, ageNew,
			genderNew, phoneNew, addressNew, fileImage, linkImage,
			serviceContext);
	}
	...
	public java.util.List<com.lcd.demo.model.Student> getStudent(
		...
		throws com.liferay.portal.kernel.exception.SystemException {
		return _studentLocalService.getStudent(name, gender, address, start, end);
	}
	...
	public java.util.List<com.lcd.demo.model.Student> getNamGenderAddress(
		...
		throws com.liferay.portal.kernel.exception.SystemException {
		return _studentLocalService.getNamGenderAddress(name, address, gender,
			start, end);
	}
	...
	public java.util.List<com.lcd.demo.model.Student> getAddress(
		java.lang.String address, int start, int end)
		throws com.liferay.portal.kernel.exception.SystemException {
		return _studentLocalService.getAddress(address, start, end);
	}

	public java.util.List<com.lcd.demo.model.Student> getGender(
		java.lang.String gender, int start, int end)
		throws com.liferay.portal.kernel.exception.SystemException {
		return _studentLocalService.getGender(gender, start, end);
	}
