...
/**
 * The utility for the student local service. This utility wraps {@link com.lcd.demo.service.impl.StudentLocalServiceImpl} and is the primary access point for service operations in application layer code running on the local server.
 *
 * <p>
 ...
 * @see com.lcd.demo.service.base.StudentLocalServiceBaseImpl
 * @see com.lcd.demo.service.impl.StudentLocalServiceImpl
 * @generated
 */
public class StudentLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to {@link com.lcd.demo.service.impl.StudentLocalServiceImpl} and rerun ServiceBuilder to regenerate this class.
	 */
	...
	*/
	public static com.lcd.demo.model.Student addStudent(
	...
	*/
	public static com.lcd.demo.model.Student createStudent(long studentId) {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static void deleteStudent(com.lcd.demo.model.Student student)
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	*/
	...
	public static com.lcd.demo.model.Student fetchStudent(long studentId)
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.lcd.demo.model.Student getStudent(long studentId)
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<com.lcd.demo.model.Student> getStudents(
		int start, int end)
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.lcd.demo.model.Student updateStudent(
		com.lcd.demo.model.Student student)
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	*/
	...
	public static com.lcd.demo.model.Student addStudents(
		java.lang.String name, int age, java.lang.String gender, int phone,
		java.lang.String address, long fileImage, java.lang.String linkImage,
		com.liferay.portal.service.ServiceContext serviceContext)
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		return getService()
				   .addStudents(name, age, gender, phone, address, fileImage,
			linkImage, serviceContext);
	}

	public static com.lcd.demo.model.Student updateStudent(long studentId,
		...
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		return getService()
				   .updateStudent(studentId, nameNew, ageNew, genderNew,
			phoneNew, addressNew, fileImage, linkImage, serviceContext);
	}

	public static java.util.List<com.lcd.demo.model.Student> getStudent(
		java.lang.String name, java.lang.String gender,
		java.lang.String address, int start, int end)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().getStudent(name, gender, address, start, end);
	}

	public static java.util.List<com.lcd.demo.model.Student> getNamGenderAddress(
		java.lang.String name, java.lang.String address,
		java.lang.String gender, int start, int end)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService()
				   .getNamGenderAddress(name, address, gender, start, end);
	}

	public static java.util.List<com.lcd.demo.model.Student> getAddress(
		java.lang.String address, int start, int end)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().getAddress(address, start, end);
	}

	public static java.util.List<com.lcd.demo.model.Student> getGender(
		java.lang.String gender, int start, int end)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().getGender(gender, start, end);
	}
	...
	public static StudentLocalService getService() {
		if (_service == null) {
			...
			ClassLoaderProxy classLoaderProxy = new ClassLoaderProxy(object,
					StudentLocalService.class.getName(), portletClassLoader);
			...
			ReferenceRegistry.registerReference(StudentLocalServiceUtil.class,
				"_service");
			MethodCache.remove(StudentLocalService.class);
		}
